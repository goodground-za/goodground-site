...
export const servicePages: ServicePageData[] = [
  {
    ...
    metaDescription:
      "Ongoing website maintenance for South African businesses: updates, security monitoring, performance checks, and small content changes, handled monthly.",
    h1: "Website maintenance and care plans for South African businesses.",
    heroIntro:
      "A website is a foundation, not a one-time job. Plugins fall out of date, content stops being accurate, and small issues turn into slow load times or security risks that nobody notices until they become a real problem. A care plan hands that watching over to us, so the site keeps performing the way it did on launch day instead of quietly degrading while nobody's looking. Most business owners don't have the time to check dependency versions or run a monthly speed test, and they shouldn't have to. That's a job for the people who built the thing in the first place.",
    ...
    painPoints: [
      {
        ...
        body: "Software falls behind quietly. Nobody notices until an outdated dependency causes a real failure, usually at the worst possible time, right when you need the site working for a launch or a busy season.",
      },
      {
        title: "Content goes stale",
        body: "Prices change, hours change, a service gets discontinued, and the website keeps saying the old version because updating it fell off everyone's list. Visitors trust what they read, even when it's wrong.",
      },
      {
        title: "Nobody's watching until it's a problem",
        body: "A slow page or a broken form can sit there for weeks costing you enquiries before anyone in the business even notices, because nobody's job is to check.",
      },
    ],
    included: [
      ...
      "Regular backups, so a bad update or a hosting issue is a quick restore, not a rebuild",
      "Uptime checks, so if the site ever goes down, we know before your customers do",
    ],
    localProof:
      "We run care plans for businesses across South Africa. If your current site runs on WordPress, you already know the drill: plugin updates, security patches, and a dashboard that won't stop nagging you about both. We build differently. Every GoodGround site is custom-coded, with no plugin ecosystem to patch and no third-party theme to break on an update, and our care plans keep it running exactly that way. Because the same team that built your site also maintains it, a care plan request doesn't start with someone else reverse-engineering a stranger's code. We already know how the site is put together, which is usually the difference between a same-day fix and a support ticket that sits in a queue for a week. It also means changes stay consistent with how the site was designed in the first place, instead of a well-meaning but disconnected edit slowly pulling the design in a different direction over time.",
    faq: [
      {
        question: "Do I need a care plan, or can I maintain the site myself?",
        answer:
          "You can maintain it yourself if you have the time and the technical know-how. Most business owners don't want that job on top of running the business, which is exactly what a care plan takes off your plate. If you'd rather handle small content edits yourself and just want the technical side covered, that's a conversation worth having too. Not every business needs the same level of care, and we'd rather scope it honestly than sell you more than you need.",
      },
      {
        question: "What happens if I'm not on a care plan and something breaks?",
        answer:
          "We'll still help, quoted as a one-off fix. A care plan exists so that call happens far less often, because small issues get caught before they become a break. One-off fixes also tend to cost more per issue than a care plan would over the same period, simply because nobody caught the problem early.",
      },
      {
        question: "Can I start a care plan after launch, or only when the site is built?",
        answer:
          "Either. Most clients add one at launch, but you can start a care plan at any point once your GoodGround site is live. If you're coming to us mid-life with a site that's been neglected for a while, we'll usually recommend a short catch-up pass first, so the plan starts from a clean baseline instead of inheriting existing problems.",
      },
      {
        question: "Does a care plan cover adding new pages, or only maintenance?",
        answer:
          "It covers small content changes. Bigger additions, like a new page or a new feature, are scoped and quoted separately, and we'll always tell you honestly which one your request is, rather than stretch the definition of \"small\" to fit whatever you've asked for.",
      },
      {
        question: "How quickly do you respond to a care plan request?",
        answer:
          "Most small content changes and minor fixes are turned around within a few working days. Anything urgent, a form that's stopped working or a page that's gone down, gets prioritised ahead of routine requests.",
      },
    ],
    ctaHref: "/contact",
