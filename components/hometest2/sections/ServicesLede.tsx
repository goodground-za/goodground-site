          ...
          {serviceTiles.map((tile) => (
            ...
            >
              <Image
                ...
                className="aspect-[3/4] w-full object-cover transition-transform duration-500 ease-[var(--ease-out)] group-hover:scale-[1.04]"
              />
              ...
              <div className="from-ht-purple/95 absolute inset-0 bg-gradient-to-t from-0% to-transparent to-58% transition-opacity duration-400 group-hover:opacity-0 group-focus-visible:opacity-0" />
              <div className="bg-ht-purple/92 absolute inset-0 opacity-0 transition-opacity duration-400 group-hover:opacity-100 group-focus-visible:opacity-100" />
              ...
              <div className="absolute inset-x-0 bottom-0 p-5">
                ...
                <div className="grid grid-rows-[0fr] transition-[grid-template-rows] duration-400 ease-[var(--ease-out)] group-hover:grid-rows-[1fr] group-focus-visible:grid-rows-[1fr]">
