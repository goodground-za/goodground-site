    ...
    >
      ...
      <div className="mt-5">
        ...
        <select
          ...
          className={`${inputBase} ${errors.projectType ? "border-ht-orange" : "border-ht-purple/15"}`}
        >
      ...
      <div className="mt-5">
        ...
        <textarea
          ...
          className={`${inputBase} resize-y ${errors.message ? "border-ht-orange" : "border-ht-purple/15"}`}
        />
