...
import { caseStudyKindLabel, getCaseStudy } from "@/content/caseStudies";

/** The label a /work case study carries ("Concept build", "Our own site"),
 * read from content/caseStudies.ts so the homepage can't disagree with it. */
function kindOf(slug: string) {
  const study = getCaseStudy(slug);
  return study ? caseStudyKindLabel(study.kind) : null;
}
    ...
    <section className="work section-dark section-pad" id="work" aria-labelledby="work-title">
          <div className="wrap">
            ...
            <div className="project-grid">
              ...
              <article className="project project-offset reveal"><Link className="project-image" href="/work/point-break-surf" aria-label="View Point Break Surf Academy project"><img src="/home2026/point-break.webp" width="1042" height="1218" loading="lazy" alt="The Point Break Surf Academy website on a laptop" /><span className="project-open" aria-hidden="true">↗︎</span></Link><div className="project-info"><h3><Link href="/work/point-break-surf">Point Break Surf Academy</Link></h3><span className="project-kind">{kindOf("point-break-surf")}</span></div><div className="tags"><span>Design</span><span>Development</span><span>Booking UX</span></div></article>
              <article className="project reveal"><Link className="project-image project-image-wide" href="/work/goodground-site" aria-label="View GoodGround project"><img src="/home2026/goodground.webp" width="1600" height="1000" loading="lazy" alt="The GoodGround website showing the studio's work and brand" /><span className="project-open" aria-hidden="true">↗︎</span></Link><div className="project-info"><h3><Link href="/work/goodground-site">GoodGround</Link></h3><span className="project-kind">{kindOf("goodground-site")}</span></div><div className="tags"><span>Design</span><span>Development</span><span>SEO</span></div></article>
              <article className="project project-offset reveal"><Link className="project-image project-image-wide" href="/work/sunbird-early-learners" aria-label="View Sunbird Early Learners project"><img src="/home2026/sunbird.webp" width="1042" height="1218" loading="lazy" alt="The Sunbird Early Learners website with its green colour palette" /><span className="project-open" aria-hidden="true">↗︎</span></Link><div className="project-info"><h3><Link href="/work/sunbird-early-learners">Sunbird Early Learners</Link></h3><span className="project-kind">{kindOf("sunbird-early-learners")}</span></div><div className="tags"><span>Design</span><span>Development</span><span>Motion</span></div></article>
            </div>
