...
export function Work() {
  return (
    <section className="work section-dark section-pad" id="work" aria-labelledby="work-title">
          <div className="wrap">
            <div className="section-meta"><span className="eyebrow">02 / Our craft</span><Link className="text-link" href="/work">View all <span aria-hidden="true">↗</span></Link></div>
