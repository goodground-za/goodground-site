...
export function PricingPageClient() {
  ...
  return (
    <>
      ...
      <section className="bg-ht-cream px-gutter py-8">
      ...
      <FAQAccordion
        ...
        heading="Before you send that enquiry."
      />

      <section
        ref={formRef}
        id="enquiry"
        className="bg-ht-cream scroll-mt-24 px-gutter pt-4 pb-20 md:pb-28 md:pt-6"
      >
